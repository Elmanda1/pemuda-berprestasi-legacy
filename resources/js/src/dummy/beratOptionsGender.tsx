export const kelasBeratOptionsByAgeGender: Record<
  "Super Pra-cadet" | "Pracadet" | "Cadet" | "Junior" | "Senior",
  {
    LAKI_LAKI: { value: string; label: string }[];
    PEREMPUAN: { value: string; label: string }[];
  }
> = {
  "Super Pra-cadet": {
    LAKI_LAKI: [
