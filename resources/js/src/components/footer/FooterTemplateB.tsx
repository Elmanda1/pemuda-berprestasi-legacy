...
const FooterTemplateB = () => {
    const { kompetisiDetail } = useKompetisi();

    const theme = {
        bg: "bg-[#0a0a0a] border-t border-gray-900",
        text: "text-gray-400",
        highlight: "text-white",
        border: "border-gray-800",
        accent: "from-gray-800",
        hoverLink: "hover:text-white",
        underline: "bg-red-600",
        circleBorder: "border-gray-800",
    };
            ...
            <div className="container mx-auto px-6 lg:px-4 relative z-10">
                ...
                <div className={`mt-8 pt-6 border-t ${theme.border} relative`}>
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <p className="text-sm font-plex text-gray-600">
...
export default FooterTemplateB;
